...
/**
 * Represents a generic task in Zirnitra with a description and marked status.
...
public abstract class Task {
     ...
     * @throws ZirnitraException If an error occurs while parsing the task data.
     */
    public static Task fromFile(String line) throws ZirnitraException {
